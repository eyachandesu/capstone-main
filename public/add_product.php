...
<head>
  ...
  <style>
    :root {
      --rose: #e59ca8;
      /* Matched the rose color from your products page */
      --rose-hover: #d27b8c;
      --rose-light: #fff0f3;
    }
    ...
    <?php if (isset($_SESSION['error'])): ?>
      <div class="m-6 mb-0 bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-lg flex items-start gap-3">
        ...
        <div>
          ...
          <p class="text-sm leading-relaxed"><?= $_SESSION['error'];
    ...
    <div class="p-8">
      <form id="productForm" method="POST" enctype="multipart/form-data" class="space-y-8" novalidate>
        ...
        <div>
          ...
          <div>
            <label class="block text-gray-700 font-semibold mb-2 text-sm">Product Name <span
                class="text-red-500">*</span></label>
            <div class="relative">
              <span class="absolute left-4 top-3.5 text-gray-400"><i class="fas fa-tag"></i></span>
              <input type="text" name="product_name" id="product_name" required
                value="<?= htmlspecialchars($old['product_name'] ?? '') ?>" placeholder="e.g. Summer Floral Dress"
        ...
        <div>
          ...
          <div class="w-full">
            <!-- Category -->
            <div>
              <label class="block text-gray-700 font-semibold mb-2 text-sm">Category <span
                  class="text-red-500">*</span></label>
              <div class="relative">
        ...
        <div>
          ...
          <!-- Upload Area -->
          <label
            class="relative flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer bg-gray-50 hover:bg-[var(--rose-light)] hover:border-[var(--rose)] transition-all group">
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
              <div
                class="w-12 h-12 rounded-full bg-gray-100 group-hover:bg-white flex items-center justify-center mb-3 transition-colors">
                <i
                  class="fas fa-cloud-upload-alt text-2xl text-gray-400 group-hover:text-[var(--rose)] transition-colors"></i>
              </div>
              <p class="text-sm text-gray-500"><span class="font-semibold text-[var(--rose)]">Click to upload</span>
                images</p>
